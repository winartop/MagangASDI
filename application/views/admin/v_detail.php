  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        ...
        <a href="<?php echo site_url('admin/alumni/'); ?>" class="btn btn-default pull-right"><i class="glyphicon glyphicon-arrow-left"></i> Kembali</a>
     ...
     <div class="modal fade" id="password" tabindex="-1" role="dialog" aria-labelledby="labelpassword" aria-hidden="true">
         <div class="modal-dialog">
           <div class="modal-content">
             ...
             <form class="form-horizontal" role="form"  action="<?php echo site_url('admin/alumni/editpass');?>" method="post">
